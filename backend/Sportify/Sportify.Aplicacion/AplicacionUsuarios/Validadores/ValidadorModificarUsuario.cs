...
<<<<<<< HEAD
public async Task<bool> validar(Usuario usuario, string idUsuario)   //huele re mal este codigo lo se pero ni a palo le aplico refactorin suckeame un egg
    {
     if (await this.repositorioUsuarios.BuscarId(idUsuario))
=======
